...
Download the Docker image, configure your DNS to point to your server, and access the web interface to create your first mailbox.

Default port: 8080 (web) / 2525 (SMTP)
